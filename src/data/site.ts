export const CLUB = {
  ...
  phone: "+7 (988) 142-59-80",
  phoneHref: "tel:+79881425980",
  address: "ул. Интернациональная, 13",
  city: "Адлер · Сочи",
  schedule: "24/7, каждый день",
  mapsHref:
    "https://yandex.ru/maps/?text=" +
    encodeURIComponent("Адлер, ул. Интернациональная, 13 Topzol"),
} as const;
...
export const FAQ: FaqItem[] = [
  {
    ...
    answer:
      "Желательно, особенно вечером, ночью и для компании. Забронировать можно по телефону +7 (988) 142-59-80 или через форму на сайте.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Адлер, ул. Интернациональная, 13. Первая береговая линия Черного моря.",
  },
];
